from odin.models.info_gan.regularized_gan import RegularizedGAN
import prettytensor as pt
import tensorflow as tf
import numpy as np
from progressbar import ETA, Bar, Percentage, ProgressBar
import sys
from odin.misc.dataset import MNIST

from odin.models.base import ModelWrapper, LayerWrapper
from odin.misc.distributions import MeanBernoulli, Gaussian, Categorical, Bernoulli, Uniform
import odin.misc.custom_ops

TINY = 1e-8


class InfoGAN(ModelWrapper):
    """
    Based on: http://papers.nips.cc/paper/6399-infogan-interpretable-representation
    """
    ...
    def __init__(self,
        ...
        :param exp_name:
        :param max_epoch:
        :param updates_per_epoch:
        :param snapshot_interval:
        :param info_reg_coeff:
        :param discriminator_learning_rate:
        :param generator_learning_rate:
        :param batch_size:
        :param kwargs:
        """
    ...
    def construct(self):
        ...
        model = RegularizedGAN(
            output_dist=MeanBernoulli(self.dataset.image_dim),
            ...
            for epoch in range(self.max_epoch):
                ...
                for i in range(self.updates_per_epoch):
                    ...
                    if counter % self.snapshot_interval == 0:
                        ...
                        fn = saver.save(sess, "%s/%s.ckpt" % (self.model_path, snapshot_name))
